...
int main(int argc, char** argv) {
	...
	while(inputFile.eof()== false)
	{
		...
		{
			if(readLine.position>previousPosition || readLine.referenceBase == "N") includeZeroCoverageInPileup();
			if(readLine.position==previousPosition && readLine.referenceBase != "N") retrieveBaseANDSnpStatistics();
    ...
    cout << "The pileup folder was successfully created. " << endl;
